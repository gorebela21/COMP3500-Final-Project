...
*(Replace this paragraph with a sentence or two describing what your project actually demonstrates — e.g. the specific protocol/cipher being downgraded and what the attack proves.)*
...
*(Add the exact flags/arguments your scripts take — host, port, target, etc. — and the expected output so a grader can reproduce it. Example: `python3 downgrade_attack.py --target 127.0.0.1 --port 5000`.)*
